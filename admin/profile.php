...
<body>
    <div class="wrapper">
        ...
        <div class="sidebar">
            <div class="sidebar-title"><b>Profile</b></div>
                <ul>
        ...
        <div class="section">
            <div class="container">
                ...
                <form id="contact" action="" method="post">
                    <h3>Profil</h3>
                    <fieldset>
                        <input type="text" name="name" placeholder="Nama Lengkap" class="form-control" value="<?php echo $d->admin_name ?>" required>
                    </fieldset>
                    <fieldset>
                        <input type="text" name="username" placeholder="Username" class="form-control" value="<?php echo $d->username ?>" required>
                    </fieldset>
                    <fieldset>
                        <input type="text" name="telpon" placeholder="Telpon" class="form-control" value="<?php echo $d->admin_telpon ?>" required>
                    </fieldset>
                    <fieldset>
                        <input type="email" name="email" placeholder="Email" class="form-control" value="<?php echo $d->admin_email ?>" required>
                    </fieldset>
                    <fieldset>
                        <input type="text" name="address" placeholder="Alamat" class="form-control" value="<?php echo $d->admin_address ?>" required>
                    </fieldset>
                    <fieldset>
                        <button name="submit" type="submit" id="contact-submit" data-submit="...Sending">Ubah Profile</button>
                    </fieldset>
                </form>
                <?php
