            ...
            <div class="container">
                ...
                <form action="" method="post" enctype="multipart/form-data">
                    ...
                    <fieldset>
                        ...
                        <input type="text" name="nama" placeholder="...Nama Produk..." class="form_control" required>
                    </fieldset>
                    <fieldset>
                        <label>Harga</label>
                        <input type="text" name="harga" placeholder="...Harga Produk..." class="form_control" required>
                    </fieldset>
                    <fieldset>
                        <label>Gambar Produk</label>
                        <input type="file" name="gambar" placeholder="...Gambar Produk..." class="form_control" required>
                    </fieldset>
                    <fieldset>
                        <label>Deskripsi Produk</label>
                        <textarea class="form_control" name="deskripsi" placeholder="Deskripsi"></textarea><br>
                    </fieldset>
                    <fieldset>
                        <label>Status</label>
